...
## Create a Soft Res list at https://raidres.fly.dev (1.12.1) or https://softres.it (2.5.2).
Ask raiders to add their items.
When ready, lock the raid and click on RollFor export (raidres.fly.dev) or Gargul Export (softes.it) button.
